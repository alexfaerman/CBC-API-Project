...
const ItemViewer = () => {
    ...
    const [itemData, setItemData] = useState(null); // State to hold the fetched item
    ...
    const handleFetchItem = async () => {
        try {
            ...
            setItemData(data); // Set the fetched item data
        } catch (err) {
            setItemData(null); // Clear previous item data
